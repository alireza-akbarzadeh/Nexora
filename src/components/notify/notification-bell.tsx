      ...
      <DropdownMenuTrigger
        render={
          ...
          >
            ...
            {badgeLabel ? (
              <span className="absolute -top-0.5 -right-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-primary px-1 text-[10px] font-semibold text-primary-foreground tabular-nums shadow-sm ring-2 ring-card">
                {badgeLabel}
              </span>
            ) : null}
          </Button>
