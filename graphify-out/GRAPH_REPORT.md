...
## Corpus Check
- 153 files · ~46,130 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 814 nodes · 1884 edges · 39 communities (32 shown, 7 thin omitted)
...
Cohesion: 0.08
Nodes (33): generateMetadata(), generateStaticParams(), PageProps, PriceSlugPage(), AssetCard(), assetHref(), AssetsSection(), hotCoins() (+25 more)

### Community 2 - "security-settings.tsx"
Cohesion: 0.06
Nodes (53): DevAuthEmail, extractUrl(), ForgotPasswordPage(), LoginPage(), TwoFactorPage(), authInputClassName, authLabelClassName, AuthError() (+45 more)
...
Cohesion: 0.07
Nodes (50): DashboardOverview(), Header(), HeaderProps, baseOf(), Category, HighlightCard(), MarketsOverview(), NEW_BASES (+42 more)
...
### Community 11 - "cn"
Cohesion: 0.13
Nodes (25): StatCard(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount(), AvatarImage(), Breadcrumb() (+17 more)
...
Cohesion: 0.14
Nodes (11): FaqSection(), FinalCtaSection(), HeroSection(), LearningSection(), LandingNav(), PricingSection(), TrustBar(), FAQS (+3 more)
...
### Community 18 - "signaling-manager.ts"
Cohesion: 0.33
Nodes (5): BinanceDepthMessage, BinanceTickerMessage, StreamCallback, Window, OrderBookLevel
...
Cohesion: 0.19
Nodes (10): Field(), FieldContent(), FieldDescription(), FieldLegend(), FieldSeparator(), FieldSet(), FieldTitle(), fieldVariants (+2 more)

### Community 34 - "nav.tsx"
Cohesion: 0.17
Nodes (11): NavFlyout(), SIMPLE_LINKS, TRADE_LINKS, Sheet(), SheetContent(), SheetDescription(), SheetFooter(), SheetHeader() (+3 more)

### Community 36 - "trade-terminal.tsx"
Cohesion: 0.20
Nodes (10): TradePageProps, OpenOrdersPanel(), Timeframe, TIMEFRAMES, TradeTerminal(), TradeTerminalProps, useOrderBook(), useTicker() (+2 more)

### Community 37 - "auth-live-markets.tsx"
Cohesion: 0.19
Nodes (11): AuthLiveMarkets(), formatMarketPrice(), MARKETS, ChangeBadge(), featuredSymbols, MarketCard(), MarketOverview(), TickerBar() (+3 more)

### Community 41 - "formatPrice"
Cohesion: 0.27
Nodes (9): PortfolioPage(), OrderBookPanel(), OrderBookRow(), OrderForm(), formatPrice(), OrderSide, OrderType, TradingState (+1 more)
...
- **Why does `cn()` connect `cn` to `coin-price-page.tsx`, `security-settings.tsx`, `nav.tsx`, `trade-terminal.tsx`, `auth-live-markets.tsx`, `field.tsx`, `utils.ts`, `user-menu.tsx`, `formatPrice`, `order-form.tsx`, `sidebar.tsx`, `landing-page.tsx`, `dashboard-shell.tsx`, `notify/index.ts`?**
