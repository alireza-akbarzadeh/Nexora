...
## Summary
- 889 nodes · 2054 edges · 44 communities (39 shown, 5 thin omitted)
...
### Community 7 - "formatPrice"
Cohesion: 0.19
Nodes (12): PortfolioPage(), AuthLiveMarkets(), formatMarketPrice(), MARKETS, OpenOrdersPanel(), OrderBookPanel(), OrderBookRow(), formatPrice() (+4 more)
...
### Community 43 - "Ticker"
Cohesion: 0.50
Nodes (3): TickerBar(), TickerBarProps, Ticker
...
- **Why does `cn()` connect `cn` to `markets-overview.tsx`, `login-page.tsx`, `sidebar.tsx`, `formatPrice`, `product/catalog.ts`, `order-form.tsx`, `paper-trade-simulator.tsx`, `dashboard-shell.tsx`, `two-factor-setup.tsx`, `notify/index.ts`, `utils.ts`, `nav.tsx`, `user-menu.tsx`, `settings/page.tsx`, `trade-terminal.tsx`, `Ticker`, `spinner.tsx`, `dashboard-overview.tsx`, `types/exchange.ts`?**
